...
| `r01_cliente_aval_mismo_domicilio` | No | Si | Solicitud + OCR comprobantes + campos de domicilio | Detecta si cliente y aval viven en el mismo domicilio. En regla general no debe ocurrir; solo puede aceptarse si uno de los dos es propietario y se comprueba con predial o escrituras |
